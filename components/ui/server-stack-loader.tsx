...
export function ServerStackLoader({ className = "" }: { className?: string }) {
  return (
    <div className={`server-stack-loader ${className}`} aria-hidden="true">
      <div className="server-stack-loader__unit">
        <svg width="74" height="90" viewBox="0 0 74 90" fill="none" xmlns="http://www.w3.org/2000/svg">
          ...
          <path className="server-stack-loader__led server-stack-loader__led--green" d="M58 72.5L60.5 71V74L58 75.5V72.5Z" fill="#17e300" />
          <path className="server-stack-loader__led" d="M63 69.5L65.5 68V71L63 72.5V69.5Z" fill="#FF715E" />
          ...
          <path className="server-stack-loader__led" d="M58 54.5L60.5 53V56L58 57.5V54.5Z" fill="#FF715E" />
          <path className="server-stack-loader__led server-stack-loader__led--delay" d="M63 51.5L65.5 50V53L63 54.5V51.5Z" fill="#FF715E" />
          ...
          <path className="server-stack-loader__led server-stack-loader__led--delay" d="M58 36.5L60.5 35V38L58 39.5V36.5Z" fill="#FF715E" />
      ...
      <div className="server-stack-loader__shadow">
